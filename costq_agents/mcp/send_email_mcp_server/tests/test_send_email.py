...
async def test_send_email_success():
    ...
    try:
        from costq_agents.mcp.send_email_mcp_server.handlers.email_handler import send_email

        # Mock SES 客户端
        with patch("costq_agents.mcp.send_email_mcp_server.utils.ses_client.send_email") as mock_send:
...
async def test_server_import():
    ...
    try:
        from costq_agents.mcp.send_email_mcp_server import server
