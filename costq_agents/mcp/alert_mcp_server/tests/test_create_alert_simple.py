...
async def main():
    ...
    try:
        ...
        from costq_agents.database.connection import get_session_local
        from costq_agents.mcp.alert_mcp_server.handlers.alert_handler import create_alert
        from costq_agents.mcp.alert_mcp_server.models.alert_models import CreateAlertParams
        from costq_agents.mcp.alert_mcp_server.utils.db_helper import AlertDBHelper, get_db_session
