...
# Import handlers
from costq_agents.mcp.gcp_cost_mcp_server.handlers.billing_handler import (
    get_cost_by_label,
    get_cost_by_project,
    get_cost_by_service,
    get_cost_by_sku,
...
from costq_agents.mcp.gcp_cost_mcp_server.handlers.budget_handler import (
    create_budget,
    get_budget_status,
    list_budgets,
)
from costq_agents.mcp.gcp_cost_mcp_server.handlers.cud_handler import (
    get_cud_coverage,
    get_cud_savings_analysis,
    list_commitments,
)
from costq_agents.mcp.gcp_cost_mcp_server.handlers.cud_handler_advanced import (
    get_cud_resource_usage,
    get_cud_status_check,
)
from costq_agents.mcp.gcp_cost_mcp_server.handlers.cud_handler_comparison import (
    get_cud_vs_ondemand_comparison,
    get_flexible_cud_analysis,
)
from costq_agents.mcp.gcp_cost_mcp_server.handlers.recommender_handler import (
...
async def gcp_cost_by_service(
    ...
    **Supports both project-level and organization-level queries.**
    ...
    from costq_agents.mcp.gcp_cost_mcp_server.models import CostByServiceParams
...
async def gcp_cost_by_project(
    ...
    **Supports organization-level filtering via billing_account_id.**
    ...
    from costq_agents.mcp.gcp_cost_mcp_server.models import CostByProjectParams
...
async def gcp_daily_cost_trend(
    ...
    from costq_agents.mcp.gcp_cost_mcp_server.models import DailyCostTrendParams
...
async def gcp_cost_by_label(
    ...
    **Supports both project-level and organization-level queries.**
    ...
    from costq_agents.mcp.gcp_cost_mcp_server.models import CostByLabelParams
...
async def gcp_cost_by_sku(
    ...
    **Supports both project-level and organization-level queries.**
    ...
    from costq_agents.mcp.gcp_cost_mcp_server.models import CostBySkuParams
...
async def gcp_cost_summary(
    ...
    **Supports both project-level and organization-level summaries.**
    ...
    try:
        ...
        from costq_agents.mcp.gcp_cost_mcp_server.models import CostSummaryParams
...
async def gcp_vm_rightsizing_recommendations(
    ...
    from costq_agents.mcp.gcp_cost_mcp_server.models import VmRightsizingRecommendationsParams
...
async def gcp_idle_resources(
    ...
    from costq_agents.mcp.gcp_cost_mcp_server.models import IdleResourcesParams
...
async def gcp_create_budget(
    ...
    from costq_agents.mcp.gcp_cost_mcp_server.models import CreateBudgetParams
...
async def gcp_list_commitments(
    ...
    **Supports both project-level and organization-level queries.**
    ...
    from costq_agents.mcp.gcp_cost_mcp_server.models import ListCommitmentsParams
...
async def gcp_cud_coverage(
    ...
    **Important**: Data excludes last 2 days due to billing lag.
    ...
    from costq_agents.mcp.gcp_cost_mcp_server.models import CudCoverageParams
...
async def gcp_cud_savings_analysis(
    ...
    **Supports both project-level and organization-level queries.**
    ...
    from costq_agents.mcp.gcp_cost_mcp_server.models import CudSavingsAnalysisParams
