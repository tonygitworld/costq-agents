...
from costq_agents.mcp.gcp_cost_mcp_server.constants import (
    DEFAULT_LOOKBACK_DAYS,
)
from costq_agents.mcp.gcp_cost_mcp_server.models.cud_models import (
    CudCoverageParams,
    CudSavingsAnalysisParams,
    CudUtilizationParams,
    ListCommitmentsParams,
)
from costq_agents.mcp.gcp_cost_mcp_server.utils.bigquery_helper import (
    validate_date_range,
)
from costq_agents.mcp.gcp_cost_mcp_server.utils.multi_account_client import (
    get_bigquery_client_for_account,
)

# Note: get_compute_client_for_account removed - no Compute API permissions
from costq_agents.services.gcp_credentials_provider import get_gcp_credentials_provider
...
async def list_commitments(ctx: Context, params: ListCommitmentsParams) -> dict[str, Any]:
    ...
    try:
        ...
        from costq_agents.mcp.gcp_cost_mcp_server.handlers.cud_handler_bigquery_v5_coverage_fixed import (
